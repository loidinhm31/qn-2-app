...
@Component({
  selector: 'app-session-item-detail',
  templateUrl: './session-item-detail.page.html',
  styleUrls: ['./session-item-detail.page.scss'],
})
export class SessionItemDetailPage implements OnInit {
